 ...
 */
public abstract class ElementBuilderTestBase<T extends ElementBuilderBase<?>> {
  ...
  protected static final String GWT_MODULE_NAME = "org.gwtproject.dom.builder.BuilderDOM";
  ...
  /**
   * Test that all implementations of a builder are consistent in their support of setting inner
   * html.
   */
  @Test
  ...
  /**
   * Test that all implementations of a builder return the same value from {@link
   * ElementBuilderBase#isEndTagForbidden()}.
   */
  @Test
  ...
  /**
   * Test that all implementations of a builder are consistent in their support of appending child
   * elements.
   */
  @Test
  ...
  /** Test that you cannot add style properties after interrupting them with an attribute. */
  @Test
  ...
  /**
   * Test that the specified command triggers an {@link IllegalStateException} after appending html
   * to the element.
   *
  ...
  /**
   * Test that the specified command triggers an {@link IllegalStateException} after ending a child
   * element.
   *
   * @param action the command to execute
   * @param message the failure message if the test fails
