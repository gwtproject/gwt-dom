...
class DOMImplWebkit extends DOMImpl {
  ...
  public native NativeEvent createKeyCodeEvent(Document doc, String type,
                                               ...
                                               int keyCode) /*-{
    var evt = this.@com.google.gwt.dom.client.DOMImplWebkit::createKeyEvent(Lcom/google/gwt/dom/client/Document;Ljava/lang/String;ZZZZZZ)(doc, type, true, true, ctrlKey, altKey, shiftKey, metaKey)
    evt.keyCode = keyCode;
    return evt;
  }-*/;
  ...
  public native NativeEvent createKeyEvent(Document doc, String type,
    ...
    var evt = this.@com.google.gwt.dom.client.DOMImplWebkit::createKeyEvent(Lcom/google/gwt/dom/client/Document;Ljava/lang/String;ZZZZZZ)(doc, type, canBubble, cancelable, ctrlKey, altKey, shiftKey, metaKey)
    evt.keyCode = keyCode;
  ...
  public native NativeEvent createKeyPressEvent(Document doc,
                                                boolean ctrlKey, boolean altKey, boolean shiftKey, boolean metaKey,
                                                int charCode) /*-{
    var evt = this.@com.google.gwt.dom.client.DOMImplWebkit::createKeyEvent(Lcom/google/gwt/dom/client/Document;Ljava/lang/String;ZZZZZZ)(doc, 'keypress', true, true, ctrlKey, altKey, shiftKey, metaKey)
    evt.charCode = charCode;
    return evt;
  }-*/;
